    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex justify-content-between">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              <li><a class="nav-link scrollto liens" href="#hero">Accueil</a></li>
        ...
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <h3 class="font-weight-bold mb-3">félicitations!</h3>
                    <p class="text-muted">la requette a été envoyé avec success.</p>
                    <div class="row mb-5">
                        <div class="col-md-8 offset-md-2">
                            <img class="img-fluid" src="../assets/img/forms/send_mail.svg"
                                 alt="send_mail">
                        </div>
                    </div>
